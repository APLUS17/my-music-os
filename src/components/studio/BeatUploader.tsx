    ...
    return (
      <>
        ...
        <Button
          ...
          className="h-8 w-8 rounded-xl bg-[var(--bg-secondary)] border-[var(--border-main)] hover:bg-[var(--bg-hover)] text-[var(--text-secondary)] hover:text-[var(--text-main)] transition-all"
          title="Load Beat"
        >
          <Music size={14} />
        </Button>
