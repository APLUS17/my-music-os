...
import { ArrowRight, Mic, Play, Pause, GripVertical, Trash2 } from 'lucide-react';
        ...
        {lines.map((line, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="absolute -left-7 top-1 w-6 flex justify-center opacity-0 group-hover:opacity-100 transition-opacity z-10">
                {!take ? (
                  <button 
                    onClick={() => onRecordStart(line.id)}
                    className="text-[var(--text-tertiary)] hover:text-red-500 transition-colors p-1"
                    title="Record Take for this line"
                  >
                    <Mic size={14} />
                  </button>
                ) : (
                  <div 
                    ...
                    className="cursor-grab active:cursor-grabbing text-[var(--accent)] hover:text-[var(--text-main)] p-1"
                  >
              ...
              <div className="flex-1 relative min-w-0">
                 ...
                 />
                 {/* Underline effect */}
                 <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-[var(--border-main)] opacity-30 pointer-events-none" />
              </div>
