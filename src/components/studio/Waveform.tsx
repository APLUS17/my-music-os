...
export const Waveform: React.FC<WaveformProps> = ({ progress, onScrub }) => {
    ...
    return (
        ...
        >
                ...
                {bars.map((height, i) => {
                    ...
                    return (
                        <div
                            ...
                            style={{
                                height: `${height}px`,
                                backgroundColor: isPlayed ? 'var(--accent-primary)' : 'var(--bg-elevated)',
            ...
            {/* Playhead */}
            <div
                className="absolute top-0 bottom-0 w-[2.5px] bg-[var(--text-primary)] rounded-full z-10 pointer-events-none"
                style={{
                    left: `${progress * 100}%`,
            ...
            >
                <div className="absolute top-[-4px] left-1/2 -translate-x-1/2 w-2 h-2 rounded-full bg-[var(--text-primary)] shadow-lg" />
                <div className="absolute bottom-[-4px] left-1/2 -translate-x-1/2 w-2 h-2 rounded-full bg-[var(--text-primary)] shadow-lg" />
            </div>
        </div>
    );
};
